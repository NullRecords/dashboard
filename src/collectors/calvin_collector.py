#!/usr/bin/env python3
"""
Calvin and Hobbes Comic Collector

Fetches Calvin and Hobbes comics from GoComics.com
"""
...
class CalvinCollector:
    """Collector for Calvin and Hobbes comics from GoComics."""
    ...
    def __init__(self, cache_dir: str = None):
        ...
        if cache_dir:
            ...
            self.cache_dir = project_root / "data" / "comics" / "calvin"
        self.cache_dir.mkdir(parents=True, exist_ok=True)
        self.cache_file = project_root / "data" / "calvin_archive.json"
        self._load_cache()
    ...
    def _fetch_comic_page(self, url: str) -> Optional[Dict[str, Any]]:
        ...
        try:
            ...
            title = og_title['content'] if og_title and og_title.get('content') else "Calvin and Hobbes"
            ...
            return {
                ...
                "image_url": image_url,
                "link": link,
                "attribution": "© Bill Watterson / GoComics"
            }
    ...
    def get_daily(self) -> Dict[str, Any]:
        """Get today's Calvin and Hobbes comic and cache it."""
